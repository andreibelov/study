    ...
    <div class="container-fluid">
        ...
        <div class="col-sm-3 col-md-2 sidebar">
            ...
            <ul class="nav nav-sidebar">
                <li class="active"><a href="#"><i class="fa fa-fw fa-home"></i> Overview <span class="sr-only">(current)</span></a></li>
                <li><a href="${pageContext.request.contextPath}/chat.jsp"><i class="fa fa-fw fa-envelope"></i> Messages<span class="badge">42</span></a></li>
