...
CREATE TABLE PROFILE (ID BIGINT NOT NULL, BIRTHDATE TIMESTAMP, CITY VARCHAR (27), COUNTRY VARCHAR (2) default 'RU', FIRSTNAME VARCHAR (32), LASTNAME VARCHAR (32), PHONE VARCHAR (16), PHOTO UUID, REGDATE TIMESTAMP, SEX VARCHAR (32) default 'UNDEFINED', STATUS VARCHAR (64), PRIMARY KEY (ID));
