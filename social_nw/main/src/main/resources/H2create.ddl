...
CREATE TABLE PROFILE (ID BIGINT NOT NULL, BIRTHDATE TIMESTAMP, CITY VARCHAR (27), COUNTRY VARCHAR (2), FIRSTNAME VARCHAR (32), LASTNAME VARCHAR (32), PHONE VARCHAR (16), PHOTO binary(16), REGDATE TIMESTAMP, SEX VARCHAR, STATUS VARCHAR (64), PRIMARY KEY (ID));
